        ...
        <div className="cont202     mt-2  ) ">
          <div className="con2 w-full h-full items-end flex rounded-xl">
            <div className="flex flex-col    gap-4  w-full mb-16 pl-20   max-sm:pl-3">
              ...
              Our live, online AI/ML workshop helps you build the skills to excel in the industry, get hired, and earn more.
              </h2>
          ...
          <div className=" w-full">
            ...
            <div className="flex flex-col gap-10 px-4 py-10 @container ">
              <div className="flex flex-col gap-4">
                ...
                This is a 6-week program. Each week we'll cover a different aspect of AI/ML. You'll learn by<br/> doing - we'll give you real-world projects to help you practice what
                  you learn. Here's the<br/> breakdown:
                </p>
              </div>
              ...
              <div className="grid grid-cols-[repeat(auto-fit,minmax(158px,1fr))] gap-3 p-0">
                <div className="flex flex-1 gap-3 rounded-lg border border-[#cedde8] bg-slate-50 p-4 flex-col cursor-pointer hover:shadow-lg hover:shadow-gray-600">
                  <div className="text-[#0d151c]" data-icon="Brain" data-size="24px" data-weight="regular">
                  ...
                  <div className="flex flex-col gap-1">
                    <h2 className="text-[#0d151c] text-base font-bold leading-tight">Week 1: Understand AI/ML</h2>
                    <p className="text-[#49779c] text-sm font-normal leading-normal">
                      Learn the fundamentals of AI/ML, data preprocessing, and model evaluation. Understand the role of AI/ML in a digital environment.
                    </p>
                  </div>
                </div>
                <div className="flex flex-1 gap-3 rounded-lg border border-[#cedde8] bg-slate-50 p-4 flex-col cursor-pointer hover:shadow-lg hover:shadow-gray-600">
                  ...
                  <div className="flex flex-col gap-1">
                    <h2 className="text-[#0d151c] text-base font-bold leading-tight">Week 2: Deep Learning</h2>
                    <p className="text-[#49779c] text-sm font-normal leading-normal">
                      Develop the skills to create deep learning models based on principles like neural networks, backpropagation, and gradient descent. Learn the importance of
                      model optimization in AI/ML.
                    </p>
                  </div>
                </div>
                <div className="flex flex-1 gap-3 rounded-lg border border-[#cedde8] bg-slate-50 p-4 flex-col cursor-pointer hover:shadow-lg hover:shadow-gray-600">
                  ...
                  <div className="flex flex-col gap-1">
                    ...
                    <p className="text-[#49779c] text-sm font-normal leading-normal">
                      Master the tools and techniques used in the industry, including TensorFlow, Keras, and PyTorch. Understand the role of a data scientist in a collaborative
                      environment.
                    </p>
                  </div>
                </div>
                <div className="flex flex-1 gap-3 rounded-lg border border-[#cedde8] bg-slate-50 p-4 flex-col cursor-pointer hover:shadow-lg hover:shadow-gray-600">
                  ...
                  <div className="flex flex-col gap-1">
                    ...
                    <p className="text-[#49779c] text-sm font-normal leading-normal">
                      Learn advanced topics like generative adversarial networks and reinforcement learning. Apply your skills to more complex projects.
                    </p>
                  </div>
                </div>
                <div className="flex flex-1 gap-3 rounded-lg border border-[#cedde8] bg-slate-50 p-4 flex-col cursor-pointer hover:shadow-lg hover:shadow-gray-600">
                  ...
                  <div className="flex flex-col gap-1">
                    ...
                    <p className="text-[#49779c] text-sm font-normal leading-normal">
                      Learn more about advance topic such as RNN, NLP and get to know more about unsupervised and supervised learning.
                    </p>
                  </div>
                </div>
                <div className="flex flex-1 gap-3 rounded-lg border border-[#cedde8] bg-slate-50 p-4 flex-col cursor-pointer hover:shadow-lg hover:shadow-gray-600">
